...
var pull= function(coll, callback) { //grabs data from Orion
...
var reloadPull = function (collection, callback) { //calls pull every 5 seconds until the program terminates
    pull(collection, callback);
